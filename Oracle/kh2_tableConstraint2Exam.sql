...
INSERT INTO RUNNINGMAN(NO,ID,PASS,NAME,NICKNAME,GENDER,ADDRESS)
VALUES(2,'bignose','4444','지석진','지는해','M','서울');
...
INSERT INTO RUNNINGMAN(NO,ID,PASS,NAME,NICKNAME,GENDER,ADDRESS)
VALUES(5,'ace','5555','송지효','천성임','F','서울');
...
INSERT INTO RUNNINGMAN(NO,ID,PASS,NAME,NICKNAME,GENDER,ADDRESS)
VALUES(8,'doli','5555','전소민','전두릅','F','일산');
